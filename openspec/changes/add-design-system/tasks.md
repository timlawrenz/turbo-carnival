...
## 1. Foundation Setup
- [ ] 1.1 Upgrade to Tailwind CSS v4
  - [ ] 1.1.1 Update tailwindcss gem/npm package
  - [ ] 1.1.2 Migrate tailwind.config.js to CSS `@theme` blocks
  - [ ] 1.1.3 Test existing styles still work
- [ ] 1.2 Install and configure Lookbook
  - [ ] 1.2.1 Add lookbook gem to Gemfile
  - [ ] 1.2.2 Create lookbook configuration
  - [ ] 1.2.3 Mount lookbook routes (development only)
- [ ] 1.3 Define design tokens in CSS
  - [ ] 1.3.1 Create `app/assets/stylesheets/design-tokens.css`
  - [ ] 1.3.2 Define color palette (primary, surface, semantic colors)
  - [ ] 1.3.3 Define typography scale (font families, sizes, weights)
  - [ ] 1.3.4 Define spacing scale
  - [ ] 1.3.5 Define border radii
  - [ ] 1.3.6 Define shadows and elevations

## 2. Base Component Library
- [ ] 2.1 Port Tailwind Plus Catalyst components to Base:: namespace
  - [ ] 2.1.1 Base::ButtonComponent (primary, secondary, outline, ghost variants)
...
- [ ] 2.2 Create Lookbook previews for each Base component
  - [ ] 2.2.1 Button preview with all variants
  - [ ] 2.2.2 Input preview with states (default, error, disabled)
  - [ ] 2.2.3 Card preview with various content
